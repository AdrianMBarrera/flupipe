...
// Based on nf-core/ViralRecon module: kraken2_build.nf (https://github.com/nf-core/viralrecon/blob/master/modules/local/kraken2_build.nf)
//
...
process KRAKEN2_BUILD {
    ...
    conda "bioconda::kraken2=2.1.3 conda-forge::pigz=2.6"
